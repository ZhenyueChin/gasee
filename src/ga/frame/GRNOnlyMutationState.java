 ...
 * @since 12/09/16.
 */
public class GRNOnlyMutationState<C extends Chromosome> extends State<C> {

    protected double reproductionRate;

    public GRNOnlyMutationState(@NotNull final Population<C> population,
  ...
  private void filter(final double probability) {
    ...
    public void reproduce() {
        ...
        for (int i=0; i<population.getSize(); i++) {
            children.add(population.getIndividualsView().get(i).getChromosome());
          }
